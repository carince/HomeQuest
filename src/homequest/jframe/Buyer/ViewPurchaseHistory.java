...
public class ViewPurchaseHistory extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger =
        java.util.logging.Logger.getLogger(ViewPurchaseHistory.class.getName());
    ...
    private void loadPurchaseHistory() {
        homequest.model.Buyer buyer = homequest.HomeQuest.getBuyer();
        java.util.List<homequest.transaction.Transaction> history =
            buyer.getPurchaseHistory();
    ...
    private JPanel createTransactionPanel(
        homequest.transaction.Transaction transaction,
        int index
    ) {
        ...
        if (
            transaction instanceof homequest.transaction.Bank ||
            transaction instanceof homequest.transaction.PagIbig
        ) {
            javax.swing.JButton duesButton = new javax.swing.JButton(
                "View Dues / Pay"
            );
            duesButton.addActionListener(e ->
                openInstallmentDuesDialog(transaction)
            );
    ...
    private void openInstallmentDuesDialog(
        homequest.transaction.Transaction transaction
    ) {
        int termMonths;
        double monthlyDue;
        ...
        if (transaction instanceof homequest.transaction.Bank) {
            homequest.transaction.Bank bankTransaction =
                (homequest.transaction.Bank) transaction;
        ...
        String summary =
            ...
            " months<br>" +
            "<b>Wallet Balance:</b> ₱" +
            String.format("%,.2f", buyer.getWalletBalance()) +
            "</html>";
...
//GEN-FIRST:event_ReturnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() ->
            new ViewPurchaseHistory().setVisible(true)
        );
    }
