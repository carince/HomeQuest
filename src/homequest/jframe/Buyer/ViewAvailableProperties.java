...
public class ViewAvailableProperties extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger =
        java.util.logging.Logger.getLogger(
            ViewAvailableProperties.class.getName()
        );
    ...
    private void loadOwnerProperties() {
        ...
        availableProps = homequest.util.PropertyFilterDialog.filterProperties(availableProps, activeFilters);
...
//GEN-FIRST:event_ReturnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() ->
            new ViewAvailableProperties().setVisible(true)
        );
    }
